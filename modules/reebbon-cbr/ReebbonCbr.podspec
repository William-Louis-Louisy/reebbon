Pod::Spec.new do |s|
  s.name           = 'ReebbonCbr'
  s.version        = '1.0.0'
  s.summary        = 'Bounded native CBR extraction for Reebbon'
  s.description    = 'Expo module providing a shared UnRAR Android/iOS CBR extractor.'
  ...
  s.source_files = [
    'ios/**/*.{h,mm,swift}',
    'native/reebbon_cbr.{hpp,cpp}',
    *unrar_sources,
  ]
  s.public_header_files = 'ios/ReebbonCbrBridge.h'
