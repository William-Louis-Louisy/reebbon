...
Le deuxieme moteur de lecture doit afficher les PDF importes localement sur iOS et Android, respecter le contrat `Reader<'pdf'>` fixe par l'ADR 0001 et preserver la mise en page du document. Le zoom et l'ajustement interactif appartiennent a RDR-PDF-02; le sommaire et les vignettes appartiennent a RDR-PDF-03.
...
- Le zoom est fixe a 1 et le double-tap est desactive pour ne pas anticiper RDR-PDF-02. La capacite `zoom` reste donc fausse, comme `continuousScroll`, le sommaire et les personnalisations EPUB.
...
Les tests Node couvrent le contrat Reader, le bridge natif simule, la validation des pages, les erreurs et la progression. Ils ne remplacent pas les validations du rendu, du glissement et du temps d'ouverture sur appareils iOS et Android.

Le mode scroll continu, le zoom, le double-tap, l'ajustement interactif, le sommaire et les vignettes restent explicitement hors de cette decision. Ils devront etendre les capacites et l'adaptateur existants sans contourner `Reader`.
