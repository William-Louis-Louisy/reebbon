export type ImportDiagnosticStage =
  | 'library-route-mounted'
  | 'library-before-db-load'
  | 'library-after-db-load'
  | 'library-before-render'
  | 'library-after-initial-render'
  | 'library-cover-mounted'
  | 'library-cover-load-start'
  | 'library-cover-load-complete'
  | 'library-cover-load-failed'
  | 'library-cover-unmounted'
  | 'library-stable'
